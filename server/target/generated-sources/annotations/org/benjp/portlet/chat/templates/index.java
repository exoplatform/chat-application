...
public static final juzu.impl.plugin.template.metadata.TemplateDescriptor DESCRIPTOR = new juzu.impl.plugin.template.metadata.TemplateDescriptor(org.benjp.portlet.chat.templates.index.class);
public Builder with() {
return new Builder();
}
