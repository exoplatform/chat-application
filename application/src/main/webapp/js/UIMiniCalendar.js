	...
	uiMiniCalendar = {
	  ...
	  show : function() {
		...
		if(!this.hideCalendarHandler) {
		  this.hideCalendarHandler = function() {uiMiniCalendar.hide();};
		}
	  ...
	  renderCalendar : function() {
	      ...
	      for ( var dayOfWeek = 0; dayOfWeek <= 6; dayOfWeek++) {
	        ...
	        if (validDay) {
	          ...
	          tableRow = tableRow + '<td><a class="' + clazz
	              + '" href="#SelectDate" onclick="uiMiniCalendar.setDate('
	          ...
	          tableRow = tableRow + '<td><a href="#SelectDate" class="otherMonth" onclick="uiMiniCalendar.setDate('
	              + _pyear + ','
	              + (_pmonth + 1) + ',' + _pday + ')">'
	              + _pday + '</a></td>';
				_pday++;
		...
		if (this.isDisplayTime) {
	      ...
	      table += '   <span><input type="text" class="InputTime" maxlength="2" value="'
	          ...
	          + '" onkeyup="uiMiniCalendar.setHour(this)" onfocus="this.parentNode.className=\'focus\'" onblur="this.parentNode.className=\'\'">'
			  + ':'
	          ...
	          + '" onkeyup = "uiMiniCalendar.setMinus(this)" onfocus="this.parentNode.className=\'focus\'" onblur="this.parentNode.className=\'\'"></span>';
	      table += ' </div>';
	    }
