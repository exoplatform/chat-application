...
$(document).ready(function(){
  ...
  var chatConfig = $("#chatapplication");
  var username = chatConfig.attr("data-username");
  var sessionId = chatConfig.attr("data-session-id");
  var chatServerURL = chatConfig.attr("data-chat-server-url");
  var chatIntervalChat = chatConfig.attr("data-chat-interval-chat");
  var chatIntervalSession = chatConfig.attr("data-chat-interval-session");
  var chatIntervalStatus = chatConfig.attr("data-chat-interval-status");
  var chatIntervalUsers = chatConfig.attr("data-chat-interval-users");
