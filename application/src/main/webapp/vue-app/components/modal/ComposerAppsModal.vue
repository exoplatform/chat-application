      ...
      <div v-else-if="appKey == 'event'" class="chat-app-event">
        ...
        <div class="chat-event-date form-horizontal">
          <div class="event-item">
            ...
            <input ref="eventDateFrom" :format="dateFormat" :placeholder="dateFormatTitle" type="text" pattern="\d{2}/\d{2}/\d{4}" required readonly @focus="initDatePicker($event)">
          ...
          <div class="event-item">
            ...
            <input ref="eventDateTo" :format="dateFormat" :placeholder="dateFormatTitle" type="text" pattern="\d{2}/\d{2}/\d{4}" required readonly @focus="initDatePicker($event)">
